...
class KakaoInterest extends StatefulWidget {
  ...
  @override
  State<KakaoInterest> createState() => _InterestState();
}

class _InterestState extends State<KakaoInterest> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                print(
                    "${widget.enteredBirth}\n${widget.enteredName}\n${widget.enteredEmail}\n${widget.enteredNickName}");
                // Create a MembersRequest object
                KakaoMembersRequest membersRequest = KakaoMembersRequest(
                ...
                await authenticationManager.kakaoSignUp(membersRequest);
